...
public abstract class ObjectPlusPlus extends ObjectPlus implements Serializable {
    @Serial
    private static final long serialVersionUID = -4408017942519826251L;
    ...
    public void destroy() {
        ...
        for (Map<Object, ObjectPlusPlus> roleLinks : links.values()) {
            roleLinks.values().removeIf(linkedObj -> linkedObj == this);
        }
